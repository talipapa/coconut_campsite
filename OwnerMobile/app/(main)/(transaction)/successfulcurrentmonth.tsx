...
import { fetchBookings, fetchCashOnlyBookingHistory, fetchCurrentMonthBookingHistory, fetchEwalletOnlyBookingHistory, fetchPreviousMonthBookingHistory, fetchSuccessfulBookingHistory, fetchVerifiedCurrentMonthBookingHistory } from '@/utils/BookingService';
...
const successfulcurrentmonth = () => {
    ...
    const refreshPageBooking = () => {
        setIsLoading(true)
        fetchVerifiedCurrentMonthBookingHistory(100)
...
export default successfulcurrentmonth;
