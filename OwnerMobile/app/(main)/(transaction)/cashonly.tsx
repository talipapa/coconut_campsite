...
import { fetchBookings, fetchCashOnlyBookingHistory, fetchCurrentMonthBookingHistory, fetchPreviousMonthBookingHistory, fetchSuccessfulBookingHistory } from '@/utils/BookingService';
...
const cashonly = () => {
    ...
    const refreshPageBooking = () => {
        setIsLoading(true)
        fetchCashOnlyBookingHistory(100)
