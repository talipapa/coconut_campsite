...
const Footer = () => {
  return (
    <div className='w-full flex flex-col justify-between h-full px-[30px] py-[40px] bg-[#56342A] text-white items-center text-center space-y-6'>
        <h2 className='font-bold text-2xl text-white'>COCONUT CAMPSITE</h2>
        {/* Facebook page */}
        <div className='flex flex-col items-center space-y-1'>
            <a href='https://www.facebook.com/profile.php?id=61558384738390' target='_blank' className='flex flex-row items-center space-x-2' rel="noreferrer">
                <FaFacebookSquare className='text-2xl text-[#234e87]'/>
                <h3 className='text-[#234e87]'>Follow us on Facebook</h3>
            </a>
        ...
        <p className='text-sm text-slate-200'>Copyright© Coconut Campsite & CDM Lakbay Team 2024 All rights reserved</p>
